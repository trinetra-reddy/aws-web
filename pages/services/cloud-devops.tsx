...
import { Cloud, Server, Zap, Shield, TrendingUp, Settings, CheckCircle, ArrowRight } from 'lucide-react'

export default function CloudDevOps() {
  const features = [
    { icon: Cloud, title: 'Cloud Migration', description: 'Seamless migration to AWS, Azure, or Google Cloud Platform' },
    { icon: Server, title: 'Infrastructure as Code', description: 'Automated infrastructure provisioning with Terraform and CloudFormation' },
    { icon: Zap, title: 'CI/CD Pipelines', description: 'Automated build, test, and deployment pipelines for faster releases' },
    { icon: Shield, title: 'Security & Compliance', description: 'Enterprise-grade security with compliance monitoring' },
    { icon: Settings, title: 'Container Orchestration', description: 'Docker and Kubernetes for scalable containerized applications' },
    { icon: TrendingUp, title: 'Monitoring & Optimization', description: 'Real-time monitoring and performance optimization' }
  ]
  ...
  return (
    <>
      <Head>
        <title>Cloud & DevOps Services | Anantha Web Solutions</title>
        <meta name="description" content="Professional Cloud and DevOps services. AWS, Azure, Google Cloud, Docker, Kubernetes, and CI/CD solutions." />
      </Head>
          ...
          <div className="container mx-auto px-6 lg:px-12 relative z-10 pt-20">
            <motion.div className="text-center max-w-4xl mx-auto" initial={{ opacity: 0, y: -30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-100 rounded-full mb-6">
                ...
                <span className="text-blue-600 font-bold text-sm uppercase tracking-wider">Cloud & DevOps</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 mb-6 leading-tight">
                Cloud & DevOps <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Solutions</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-600 leading-relaxed mb-8">
                Accelerate your digital transformation with cloud infrastructure and DevOps automation. We help you build, deploy, and scale applications faster and more reliably.
              </p>
          ...
          <div className="container mx-auto px-6 lg:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <motion.div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-3xl p-8 md:p-12 text-white shadow-2xl" initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
                <h3 className="text-2xl md:text-3xl font-bold mb-6">Ready to Modernize Your Infrastructure?</h3>
                <p className="text-xl text-white/90 mb-8">Let's build a scalable, secure cloud infrastructure for your business.</p>
